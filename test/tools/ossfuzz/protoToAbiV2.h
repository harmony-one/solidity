...
private:
	...
	void visit(SignedIntegerValue const&, unsigned);
	void visit(UnsignedIntegerValue const&, unsigned);
	void visit(FixedByteArrayType const&);
	void visit(FixedByteArrayValue const&, unsigned);
