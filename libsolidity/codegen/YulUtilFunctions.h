...
public:
	...
	/// the specified slot and offset. If offset is not given, it is expected at
	/// runtime parameter.
	/// signature: (slot, [offset,] value)
	std::string updateStorageValueFunction(Type const& _type, boost::optional<unsigned> const _offset);
